...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="about.php" class="nav-link text-white active">
    ...
    <hr>
      ...
      <a href="./operation/logout.php" class="nav-link text-white ">
  ...
  <?php  if(isset($_GET['alert'])){?>
        <div class="alert alert-success alert-dismissible fade show my-5  mb-0" role="alert" style="margin-left:30%;width:40rem">
    ...
    <div class="card " style="width: 40rem; margin:5% 0% 0% 30%; ">
      ...
      <div class="card-body">
        ...
        <a href="./operation/delete.php?id=<?php  echo $row['id'];?>" class="btn btn-danger">Delete Profile</a>
      </div>
    </div>
